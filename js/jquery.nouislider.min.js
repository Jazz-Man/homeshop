  ...
  f.fn.noUiSlider = function (C, D) {
    ...
    function p(a, b, c, d) {
      ...
      b.on(a, function (a) {
        ...
        if (e.hasClass("noUi-state-tap") || void 0 !== b && null !== b) {
          return !1;
        }
        var g;
        a.preventDefault();
        ...
        if (h || l) {
          l || void 0 !== window.pageXOffset || (window.pageXOffset
            = document.documentElement.scrollLeft, window.pageYOffset = document.documentElement.scrollTop), g
            = a.clientX + window.pageXOffset, v = a.clientY + window.pageYOffset;
        }
        g = f.extend(H, {
          pointX: g,
          pointY: v,
    ...
    function J(a, b, c) {
      ...
      "string" === typeof b && (b
        = [
        f('<input type="hidden" name="' + b + '">').appendTo(a).addClass(g[3]).change(function (a) {
          a.stopPropagation()
        }), "val"
      ]);
      return [b]
    ...
    function M(a, b, c) {
      ...
      if (1 === d.length) {
        ...
        if (0 > k && !a && !d[0].data("pct") || 100 === e && 100 < m && 100 === d[1].data("pct")) {
          return;
        }
        w(d[0], a);
        w(d[1], e)
    ...
    function Q(a, b) {
      ...
      f.each({
        ...
        start        : {
          ...
          t: function (a, b, d) {
            if (1 === b.handles) {
              return f.isArray(a) && (a = a[0]), a = parseFloat(a), b.start = [a], n(a);
            }
            b[d] = c(a);
            return !!b[d]
          }
    ...
    function R(a) {
      ...
      return this.each(function () {
        ...
        for (c = 0; c < a.handles; c++) {
          e = f("<div><div/></div>").appendTo(k), e.addClass(g[1]), e.children().addClass([
            g[2],
            g[2] + g[7 + a.direction + (a.direction ? -1 * c : c)]
          ].join(" ")), e.data({
            base   : k,
            target : b,
            options: a,
        ...
        b.val(a.start);
        if (!a.behaviour.fixed) {
          for (c = 0; c < d.length; c++) {
            p(q.start, d[c].children(), B, {
              b     : k,
              target: b,
              a     : [d[c]]
            });
        ...
        a.behaviour.drag && (c = k.find("." + g[9]).addClass(g[18]), a.behaviour.fixed && (c
          = c.add(k.children().not(c).data("grab"))), p(q.start, c, B, {
          b     : k,
          target: b,
          a     : d
        }))
