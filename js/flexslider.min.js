    ...
    v = {
      init                  : function () {
        ...
        if (r.vars.controlsContainer !== "") {
          r.controlsContainer
            = e(r.vars.controlsContainer).length > 0 && e(r.vars.controlsContainer);
        }
      ...
      pausePlay             : {
        ...
        update: function (e) {
          e === "play"
            ? r.pausePlay.removeClass(i + "pause").addClass(i + "play").html(r.vars.playText)
            : r.pausePlay.removeClass(i + "play").addClass(i + "pause").html(r.vars.pauseText)
        }
      },
      touch                 : function () {
            ...
            if (!f || Number(new Date) - a > 500) {
              ...
              if (!p && n.transitions) {
                if (!n.vars.animationLoop) {
                  u = m / (n.currentSlide === 0 && m < 0 || n.currentSlide === n.last && m > 0
                      ? Math.abs(m) / o + 2
                      : 1)
                }
