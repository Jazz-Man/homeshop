...
+function (a) {
  ...
  b.DEFAULTS = {
    ...
    return b
      = a.extend({}, this.getDefaults(), this.$element.data(), b), b.delay && typeof b.delay == "number" && (b.delay = {
      show: b.delay,
      hide: b.delay
    }), b
    ...
    if (this.hasContent() && this.enabled) {
      ...
      var e = typeof this.options.placement == "function"
      ...
      if (g) {
        ...
        e = e == "bottom" && h.top + h.height + j - m > o
          ? "top"
          : e == "top" && h.top - m - j < 0
              ? "bottom"
              : e == "right" && h.right + i > n
    ...
    isNaN(h) && (h = 0), isNaN(i) && (i = 0), b.top = b.top + h, b.left
      = b.left + i, a.offset.setOffset(e[0], a.extend({
      using: function (a) {
        e.css({
    ...
    if (/bottom|top/.test(c)) {
      var l = 0;
      b.left < 0 && (l = b.left * -2, b.left = 0, e.offset(b), j = e[0].offsetWidth, k
        = e[0].offsetHeight), this.replaceArrow(l - f + j, j, "left")
    }
    else {
    ...
    return c.removeClass("in"), a.support.transition && this.$tip.hasClass("fade")
