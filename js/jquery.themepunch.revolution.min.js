...
(function (e, t) {
  ...
  function N(e, n) {
    ...
    if (o.data("lazyload") != t && o.data("lazyload") != "undefined" && o.data("lazydone") != 1) {
      ...
      o.data("orgw", 0);
      s.data("loadeddone", 1);
      e.find(".tp-loader").css({display: "block"}).transition({
        opacity : 1,
        duration: 300
      });
      var f = new Image;
  ...
  function C(n, r) {
    ...
    if (l == 11 || l == 26) {
      ...
      f.find(".slotslide").each(function (t) {
        var n = e(this);
        TweenLite.fromTo(n, N / 1e3, {opacity: 0}, {
          opacity: 1,
          ease   : Power2.easeInOut
        })
      });
              ...
              if (!n.hasClass("HasListener")) {
                try {
                  ...
                  if (f.data("autoplay") == true) {
                    ...
                    s = new YT.Player(c, {events: {onStateChange: H}});
                  }
      ...
      return this.each(function () {
        ...
        if (!u.hasClass("revslider-initialised")) {
          ...
          if (o.lazyLoad == "on") {
            ...
            if (P.data("lazyload") != t) {
              P.attr("src", P.data("lazyload"));
            }
            P.data("lazydone", 1);
            D = P.parent()
          }
